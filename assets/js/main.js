...
// const modalViewsContainer = document.querySelectorAll('.services__modal-container');
const modalBtns = document.querySelectorAll('.services__button');
const modalClose = document.querySelectorAll('.services__modal-close');
let modal = function(modalClick){
    modalViews[modalClick].classList.add('active-modal')
}
// let modalBg = function(modalClick){
//     modalViews[modalClick].classList.add('active-modal')
// }
...
//Wee validate if the user previously chose a topic
if(selectedTheme){
...
themeButton.addEventListener('click',()=>{
    ...
    //We save there and the current icon that the user chose
